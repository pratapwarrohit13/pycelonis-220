...
from pycelonis.service.integration.service import DataExportStatusResponse, ExportStatus, IntegrationService
...
class DataExport(DataExportStatusResponse):
    ...
    @classmethod
    def from_transport(
        cls, client: Client, data_model_id: str, data_export_transport: DataExportStatusResponse
    ) -> "DataExport":
    ...
    def wait_for_execution(self) -> None:
        ...
        def format_status(data_export_status: DataExportStatusResponse) -> str:
            ...
            if data_export_status.export_status:
                formatted_export_status += f" {data_export_status.export_status.value}"
