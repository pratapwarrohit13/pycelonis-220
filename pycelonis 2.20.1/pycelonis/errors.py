...
if typing.TYPE_CHECKING:
    ...
    from pycelonis.service.integration.service import DataModelLoadStatus, ExportStatus, ProxyExportStatusV2
    from pycelonis.service.semantic_layer.service import ProxyExportStatusV2 as SemanticProxyExportStatusV2
...
class PyCelonisReloadFailedError(PyCelonisError):
    ...
    def __init__(self, load_status: typing.Optional["DataModelLoadStatus"], message: typing.Optional[str]):
        ...
        super().__init__(message=f"{load_status if load_status else ''} {message}".strip())
...
class PyCelonisNodeAlreadyExistsError(PyCelonisError):
    """Raised when node key already exists."""
...
class PyCelonisDataExportFailedError(PyCelonisError):
    ...
    def __init__(
        self,
        export_status: typing.Optional[
            typing.Union["SemanticProxyExportStatusV2", "ProxyExportStatusV2", "ExportStatus"]
        ],
        message: typing.Optional[typing.Union[typing.List[typing.Optional[str]], str]],
    ):
        ...
        super().__init__(message=f"{export_status if export_status else ''} {message}".strip())
...
class PyCelonisDataExportNotEnabledError(PyCelonisError):
    ...
    def __init__(self) -> None:
        ...
        super().__init__(
            message="Data Export not enabled or missing permissions. "
            "Please check permissions or create a ticket for Celonis customer support explaining why you need data "
            "export to be enabled. Data Export is disabled by default for each team."
        )
