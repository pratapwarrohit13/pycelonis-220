...
class PQLParser:
    ...
    def convert_filter_to_expressions(client: Client, data_model_id: str, query: str) -> List[str]:
        ...
        """
        parsed_tree = PQLParser._parse_tree(client, data_model_id, query, PqlQueryType.FILTER)
    ...
    @staticmethod
    def _parse_tree(client: Client, data_model_id: str, query: str, query_type: PqlQueryType) -> PqlParseTreeResponse:
