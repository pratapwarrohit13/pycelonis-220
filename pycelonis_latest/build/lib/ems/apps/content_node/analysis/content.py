...
class AnalysisSheet(PyCelonisBaseModel, extra=Extra.allow):
...
class AnalysisDocument(PyCelonisBaseModel, extra=Extra.allow):
...
class AnalysisContent(PyCelonisBaseModel, extra=Extra.allow):
